...
def main():
	...
	for i in block_number:
	   if not i == 1 and (i == 2 or i == 3):
	      block_world = hokuyo2world(range_min, range_max, angle_min, angle_max, angle_increment, ranges, i-loop)
	   elif i == 1:
	      block_world = hokuyo2world(range_min, range_max, angle_min, angle_max, angle_increment, ranges, i)
	   else:
